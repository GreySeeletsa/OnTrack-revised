...
app.post('/send-email', function(req, res) {
  ...
  let content = `Thanks for signing up to OnTrack! You are now ready to invite members to your team. Sign in to the dashboard on OnTrack and send your team members an invite. <a href="http://localhost:3000/#/">OnTrack</a>`;

  let mailOptions = {
    from: creds.USER, // sender address
    to: 'seeletsagrey@gmail.com', // list of receivers
...
app.post('/add-member', function(req, res) {
  ...
  const link = `<a href="http://localhost:3000/#/dashboard">OnTrack.com</a>`;
  let content = `You have been invited to join to OnTrack go to this link to join your team ${link}`;

  let mailOptions = {
    from: creds.USER, // sender address
    to: 'sanaseeltsa@gmail.com', // list of receivers
    subject: 'Welcome to OnTrack', // Subject line
